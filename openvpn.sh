...
dhcp-option DNS 1.1.1.1
dhcp-option DNS 1.0.0.1
http-proxy $(wget -qO- ipv4.icanhazip.com) 8118
http-proxy-option CUSTOM-HEADER ""
...
cat > /root/SUN-FREEYOUTUBE.ovpn <<-END
client
dev tun
proto tcp-client
remote $(wget -qO- ipv4.icanhazip.com) 110
...
END
cat > /root/GLOBE-TM-GAMES99.ovpn <<-END
client
dev tun
proto tcp-client
remote $(wget -qO- ipv4.icanhazip.com) 110
...
zip /var/www/html/config.zip GLOBE-TM-GAMES99.ovpn SMART-AT-PROMO.ovpn SUN-TU200.ovpn SUN-CTC50-TU50-FIXPLAN.ovpn SUN-NOLOAD.ovpn SUN-FREEYOUTUBE.ovpn GLOBE-TM-GOWATCHNPLAY.ovpn DEFAULT-NO-PROXY.ovpn DEFAULT-WITH-PROXY.ovpn
rm /root/*
